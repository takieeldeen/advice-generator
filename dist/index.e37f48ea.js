...
const adviceController = async function() {
    ...
    await _model.getJSON();
    //render the new advice
    (0, _viewDefault.default).render(_model.state.advice);
};
function init() {
    (0, _viewDefault.default).handleBtn(adviceController);
}
init();

},{"./model":"Y4A21","./view":"ky8MP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kYpTN","aenu9"], "aenu9", "parcelRequire326d")
